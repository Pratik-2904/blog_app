...
class UserSignUp implements Usecase<String, UserSignUpParams> {
  final AuthRepository
      authRepository; // dont use implementation because we dont want to hvaed dependency on implementation but in interface
  UserSignUp(this.authRepository);

  @override
  Future<Either<Failure, String>> call(UserSignUpParams params) async {
    final responce = await authRepository.signUpWithEmailPassword(
